...
from modules.cmga import BoxCMGA
...
cmga = BoxCMGA(cmgs_availability=availability, cmgs_momenta=cmgs_momenta)

# define simulation parameters
n_points = 50
det_limit = 1e-1
fig_path = "savecmg/examples/figures/" 
fig_name = "box_" + "".join([str(int(x)) for x in availability]) + "_" + str(n_points) + "points.html"
